...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="/resources/landing/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet"
          type="text/css">
...
<body>
<div id="wrapper" style="width:70%; margin: 0 auto; text-align: center;">
    <h1> Подходящие вам тарифы </h1>
     <hr />
    <ul style="margin-top:35px;">
    <#list tariffs as t>
        <div style="border-style: solid;
    border-width: 5px; margin-bottom:20px;">
        <li class="tarif" style="list-style-type:none;">
            <h2 style="color:royalblue">${t.name}</h2>
            <h3>${t.price}</h3>
            <ul>
                <#list t.features as f>
                    <li style="list-style-type:none">${f}</li>
                </#list>
            </ul>
        </li>
        </div>
